...
def get_market_data(
    ...
    - "mootdx": China A-shares via 通达信 TCP protocol (optional dependency)
    ...
    - "a_stock_data": China A-shares via the a-stock-data adapter (Tencent OHLCV + companion research endpoints)
    ...
    Args:
        ...
        start_date: Start date (YYYY-MM-DD).
        end_date: End date (YYYY-MM-DD).
        source: Data source ("auto", "yfinance", "okx", "tushare", "mootdx", "baostock", "tencent", "a_stock_data", "akshare", "ccxt").
